...
namespace Nallıhan_Kütüphane_Otomasyon_Sistemi {
    ...
    public partial class LibraryDataSet4 : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BooksRow AddBooksRow(long Barcode, string Type, string Author, int Edition, int Pages, string Explain, System.DateTime Date, int Score, int Reader, string Note, string Image, string Books_Name) {
...
namespace Nallıhan_Kütüphane_Otomasyon_Sistemi.LibraryDataSet4TableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Books] ([Barcode], [Type], [Author], [Edition], [Pages], [Explain], [Date], [Score], [Reader], [Note], [Image], [Books_Name]) VALUES (@Barcode, @Type, @Author, @Edition, @Pages, @Explain, @Date, @Score, @Reader, @Note, @Image, @Books_Name);
SELECT ID, Barcode, Type, Author, Edition, Pages, Explain, Date, Score, Reader, Note, Image, Books_Name FROM Books WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [Barcode] = @Barcode, [Type] = @Type, [Author] = @Author, [Edition] = @Edition, [Pages] = @Pages, [Explain] = @Explain, [Date] = @Date, [Score] = @Score, [Reader] = @Reader, [Note] = @Note, [Image] = @Image, [Books_Name] = @Books_Name WHERE (([ID] = @Original_ID) AND ((@IsNull_Barcode = 1 AND [Barcode] IS NULL) OR ([Barcode] = @Original_Barcode)) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_Edition = 1 AND [Edition] IS NULL) OR ([Edition] = @Original_Edition)) AND ((@IsNull_Pages = 1 AND [Pages] IS NULL) OR ([Pages] = @Original_Pages)) AND ((@IsNull_Explain = 1 AND [Explain] IS NULL) OR ([Explain] = @Original_Explain)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_Score = 1 AND [Score] IS NULL) OR ([Score] = @Original_Score)) AND ((@IsNull_Reader = 1 AND [Reader] IS NULL) OR ([Reader] = @Original_Reader)) AND ((@IsNull_Note = 1 AND [Note] IS NULL) OR ([Note] = @Original_Note)) AND ((@IsNull_Image = 1 AND [Image] IS NULL) OR ([Image] = @Original_Image)) AND ((@IsNull_Books_Name = 1 AND [Books_Name] IS NULL) OR ([Books_Name] = @Original_Books_Name)));
SELECT ID, Barcode, Type, Author, Edition, Pages, Explain, Date, Score, Reader, Note, Image, Books_Name FROM Books WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Barcode, Type, Author, Edition, Pages, Explain, Date, Score, Reader, N" +
                "ote, Image, Books_Name FROM dbo.Books";
        ...
        public virtual int Fill(LibraryDataSet4.BooksDataTable dataTable) {
        ...
        public virtual LibraryDataSet4.BooksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LibraryDataSet4.BooksDataTable dataTable = new LibraryDataSet4.BooksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LibraryDataSet4.BooksDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, global::System.Nullable<long> Original_Barcode, string Original_Type, string Original_Author, global::System.Nullable<int> Original_Edition, global::System.Nullable<int> Original_Pages, string Original_Explain, global::System.Nullable<global::System.DateTime> Original_Date, global::System.Nullable<int> Original_Score, global::System.Nullable<int> Original_Reader, string Original_Note, string Original_Image, string Original_Books_Name) {
            ...
            if ((Original_Books_Name == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[24].Value = ((string)(Original_Books_Name));
            }
        ...
        public virtual int Insert(global::System.Nullable<long> Barcode, string Type, string Author, global::System.Nullable<int> Edition, global::System.Nullable<int> Pages, string Explain, global::System.Nullable<global::System.DateTime> Date, global::System.Nullable<int> Score, global::System.Nullable<int> Reader, string Note, string Image, string Books_Name) {
            ...
            if ((Books_Name == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[11].Value = ((string)(Books_Name));
            }
        ...
        public virtual int Update(
            ...
            if ((Books_Name == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Books_Name));
            }
            ...
            if ((Original_Books_Name == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[36].Value = ((string)(Original_Books_Name));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_Image, 
                    string Original_Books_Name) {
            return this.Update(Barcode, Type, Author, Edition, Pages, Explain, Date, Score, Reader, Note, Image, Books_Name, Original_ID, Original_Barcode, Original_Type, Original_Author, Original_Edition, Original_Pages, Original_Explain, Original_Date, Original_Score, Original_Reader, Original_Note, Original_Image, Original_Books_Name, Original_ID);
        }
    }
